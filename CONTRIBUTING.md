...
3. **Write your skill** using the template at [`_template/SKILL.md`](_template/SKILL.md) as a guide. See [`synapse/skills/synapse-python-client/SKILL.md`](synapse/skills/synapse-python-client/SKILL.md) for a complete example.
